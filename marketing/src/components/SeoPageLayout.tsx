  ...
  return (
    <div className="min-h-svh bg-void pb-28 text-ink md:pb-0">
      ...
      <main id="main" className="mx-auto max-w-2xl px-6 pb-16 pt-8 sm:px-10">
        ...
        <p className="mt-4 text-lg font-normal leading-relaxed text-mute">{lead}</p>
        ...
        <div className="mt-12 space-y-8 text-base font-normal leading-relaxed text-mute sm:mt-14">
          {children}
        </div>
