...
export const GUIDE_PAGES_FR: GuidePageContent[] = [
  {
...
export const GUIDE_PAGES_EN: GuidePageContent[] = [
  {
    path: "/guides/excel-vers-logiciel-interventions",
    eyebrow: "Guide",
    title: "From Excel to field service software",
    lead: "A practical checklist for an SMB already running jobs in a spreadsheet that wants a map, mobile and fewer errors — without a six-month IT project.",
    sections: [
      {
        h2: "Signs Excel is no longer enough",
        bullets: [
          "Several versions of the same file are circulating",
          "You cannot see who is on which job live",
          "Photos and signatures are not in the right case",
          "Billing depends on manual re-typing",
        ],
      },
      {
        h2: "What field software adds",
        paragraphs: [
          "One job = one shared case: status, map address, history, documents. Technicians work in their mobile hub; the office keeps the overview.",
        ],
        bullets: [
          "Map and filters (date, technician, area)",
          "Assignment and team notifications",
          "Offline mode for the field (PWA)",
        ],
      },
      {
        h2: "Migration in 5 steps (without freezing work)",
        ordered: [
          "List “active” cases (not the full history)",
          "Open Nota and create your workspace in the app",
          "Enter active jobs one by one (30 minutes is enough to try)",
          "Train one pilot technician on mobile for half a day",
          "Drop Excel only when the whole team uses shared statuses",
        ],
      },
      {
        h2: "Mistakes to avoid",
        bullets: [
          "Migrating 5 years of history on day one",
          "Keeping WhatsApp in parallel with no rule (“everything in the case”)",
          "Picking a factory ERP when you need field software",
        ],
      },
    ],
    faq: [
      {
        question: "How long to be operational?",
        answer:
          "For a small team, a few hours entering active cases is enough to work day to day on Nota.",
      },
      {
        question: "Do I need to sign up on heynota.app?",
        answer: "No: the site sends you to the app in one click, with no marketing form.",
      },
    ],
  },
];
